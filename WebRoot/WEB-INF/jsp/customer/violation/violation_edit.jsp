			...
			<div class="page-content">
				<div class="row">
					...
					<form action="violation/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="VIOLATION_ID" id="VIOLATION_ID" value="${pd.VIOLATION_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注117:</td>
								<td><input type="text" name="WFLB" id="WFLB" value="${pd.WFLB}" maxlength="20" placeholder="这里输入备注117" title="备注117" style="width:98%;"/></td>
							</tr>
							<tr>
